                ...
                if (Utils.isMissingValue(val1) || Utils.isMissingValue(val2)) {
                    ...
                    if((int) val1 == (int) val2) return 0;
                        ...
                        for (int i = 0; i < numClass; i++) {
                            diff += Math.abs(probabilities.get((int)val1).get(i) - probabilities.get((int)val2).get(i));
                        }
                        return diff;
                    }
                }
